...
public class CheckIn extends JFrame
{
	...
	void prepareGUI()
	{
		...
		controlPanel.setLayout(gbl_controlPanel);
                ...
                JLabel checkInLabel=new JLabel("Check In Book",JLabel.CENTER);
		checkInLabel.setFont(new Font("Ariel",Font.BOLD,18));
		GridBagConstraints gbc_checkInLabel=new GridBagConstraints();
		gbc_checkInLabel.insets=new Insets(0,0,5,0);
		gbc_checkInLabel.gridx=0;
		gbc_checkInLabel.gridy=1;
		gbc_checkInLabel.gridwidth=2;
		controlPanel.add(checkInLabel, gbc_checkInLabel);
		...
		lblBorrower.setFont(new Font("Ariel",Font.BOLD,14));
