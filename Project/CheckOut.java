...
public class CheckOut extends JFrame
{
	...
	void prepareGUI()
	{
		...
		controlPanel.setLayout(gbl_controlPanel);
                ...
                JLabel checkOutLabel=new JLabel("Check Out Book",JLabel.CENTER);
		checkOutLabel.setFont(new Font("Ariel",Font.BOLD,18));
		GridBagConstraints gbc_checkOutLabel=new GridBagConstraints();
		gbc_checkOutLabel.insets=new Insets(0,0,5,0);
		gbc_checkOutLabel.gridx=0;
		gbc_checkOutLabel.gridy=1;
		gbc_checkOutLabel.gridwidth=2;
		controlPanel.add(checkOutLabel, gbc_checkOutLabel);
