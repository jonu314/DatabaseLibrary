...
public class Fines extends JFrame
{
	...
	void prepareGUI()
	{
		...
		//Borrower Card No.
		JLabel lblcard=new JLabel("Card Number :",JLabel.LEFT);
		...
		//All Fines Due
		JButton finesDue=new JButton("View My Fines");
		...
		//Paid Fines
		JButton paidFines=new JButton("Book Payment History");
		//checkOut.setLocation(50, 50);
		...
		//Total Amount Due***************************************
		JButton totalDue=new JButton("My Outstanding Balance");
		//checkOut.setLocation(50, 50);
		...
		gbc_btnClose.insets = new Insets(20, 0, 5, 0);
