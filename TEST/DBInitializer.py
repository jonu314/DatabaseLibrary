...
cursor.execute(f"DROP DATABASE IF EXISTS Proj1;")
cursor.execute(f"CREATE DATABASE IF NOT EXISTS Proj1;")
cursor.execute(f"USE Proj1;")
...
# Path to borrowers.csv
borrowers_csv_file_path = 'borrowers.csv'
#'C:/Users/huynh/Downloads/borrowers.csv'
